        ...
        <div className='flex flex-col lg:flex-row justify-center items-center px-4 md:px-16 gap-x-16'>
          ...
          <h1 className='text-2xl sm:text-4xl font-medium tracking-wide'>Streamlined <span className='text-[#4C5FF7]'>adherence reports</span> for healthcare providers</h1>
            ...
            <div className='flex items-center'>
              ...
              className='w-[75%] md:w-[60%] overflow-hidden bg-[#F3F3F3] outline-none text-sm md:text-base text-[#B8B8B8] indent-2 px-2 py-2 md:px-6 md:py-4 rounded-full rounded-r-none'
              onChange={(e) => setSearchId(e.target.value)}
              />
              <button 
              onClick={handleSearch}
              className='flex bg-[#4C5FF7] relative right-6 text-sm md:text-base text-white px-3 py-1.5 md:px-6 md:py-4 gap-x-2 rounded-full overflow-hidden z-10'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
